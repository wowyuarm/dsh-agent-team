export const zh = {
  ...
  clearContextNotice: '将丢弃 {name} 的全部对话历史，并从空上下文重新开始。此操作不可撤销。',
  clearContextConfirm: '确认清空',
...
export const en = {
  ...
  clearContextNotice: 'This discards {name}\'s entire conversation history and starts from an empty context. This cannot be undone.',
