export const zh = {
  ...
  clearContextNotice: '将清空 {name} 的当前会话上下文并从空白开始：旧对话历史会被移除且无法恢复。{name} 的身份、私有记忆与 notes、频道和会话绑定都保持不变，后续协作从新上下文继续累积。',
...
export const en = {
  ...
  clearContextNotice: 'This clears {name}\'s current session context and starts blank: the old conversation history is removed and cannot be recovered. {name}\'s identity, private memory and notes, channel and session bindings are untouched, and future collaboration accumulates from the new context.',
