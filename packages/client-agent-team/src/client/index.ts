        ...
        dispose = ctx.slots.register({
          ...
          inject: () => ({
            ...
            ...(name === 'conversation' ? {
              ...
              loadThreadObservations: (request: AgentTeamThreadObservationsRequest) => ctx.remote.agentTeam.threadObservations(request),
              changeAttention: (request: AgentTeamThreadAttentionRequest) => ctx.remote.agentTeam.changeAttention(request),
