...
**Status:** in-progress（代码与单测完成 2026-09-11；浏览器验收待 operator 环境执行——见下方 test:browser 条目的沙箱对照记录）
...
- [ ] `npm run test:browser` 通过;desktop 与 390×844 截图人工过目;键盘/焦点与普通 DSH 恢复不受影响
