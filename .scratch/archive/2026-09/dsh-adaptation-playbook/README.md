...
状态：**已归档**（2026-09-07 从 `hoplite/knidos-1ba70555` 分支抢救归档：阶段 0 latest-tag 触发信号与阶段 1 扫描方法论尚未被 docs/skills 吸收，下次 dsh 发版直接从本文复用）。原注——从 0.1.2-rc.1 适配（2026-09-03 → 09-04 发布 0.1.7）收敛的完整流程经验。
最后核对：2026-09-04
