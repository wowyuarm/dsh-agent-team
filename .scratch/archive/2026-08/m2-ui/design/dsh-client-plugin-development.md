...
1. M2-01 至 M2-06 已完成；完整验收见 `.scratch/archive/2026-08/m2-ui/issues/06-verify-team-ui-journey.md` 和 `.scratch/archive/2026-08/validation/browser/`。
2. 本项目 M2 设计出口：`.scratch/archive/2026-08/m2-ui/spec.md`。
