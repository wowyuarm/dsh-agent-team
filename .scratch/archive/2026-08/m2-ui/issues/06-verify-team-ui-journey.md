...
- [x] Real browser screenshots are stored under `.scratch/archive/2026-08/validation/browser/`; `npm run test:browser` reproduces the journey with the official Harness Web scaffold.
