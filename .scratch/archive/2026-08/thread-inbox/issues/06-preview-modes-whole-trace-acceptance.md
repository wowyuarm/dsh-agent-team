...
- [x] `docs/development.md`、根 README、相关 package README、`docs/README.md` 和已存在的 `docs/team-collaboration.md` 只在对应脚本、preset、tool、Host 和 Client 行为被验证后更新；本目录 README 指向已完成 evidence。
