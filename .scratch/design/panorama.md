...
日期：2026-08-14
状态：上层原则基线；具体领域词汇见 `../CONTEXT.md`，M1 架构与实现约束见 `architecture.md`。
...
正式包、operation ledger、authority、投递、Member lifecycle、MessageSource、teardown 和 M1 验收由 `architecture.md` 统一规定。UI 由 `design-ux.md` 规定，四工具由 `tools-research.md` 规定，领域词汇由 `../CONTEXT.md` 规定。
