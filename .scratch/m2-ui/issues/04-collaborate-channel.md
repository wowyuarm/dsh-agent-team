...
**Status:** in-progress; Channel selection, bounded timeline, structured send and lightweight live invalidation are implemented. Header membership controls and final layout/REAL journey evidence remain.
